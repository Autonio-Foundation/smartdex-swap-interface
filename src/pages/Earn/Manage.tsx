...
export default function Manage({
  ...
  const countUpAmount1 = stakingInfo?.earnedAmount1?.toFixed(4) ?? '0'
  const countUpAmountPrevious = usePrevious(countUpAmount) ?? '0'
  const countUpAmountPrevious1 = usePrevious(countUpAmount1) ?? '0'
              ...
              <RowBetween style={{ alignItems: 'baseline' }}>
                <TYPE.largeHeader fontSize={36} fontWeight={600}>
                  <CountUp
                    ...
                    isCounting
                    decimalPlaces={4}
                    start={parseFloat(countUpAmountPrevious1)}
                    end={parseFloat(countUpAmount1)}
                    thousandsSeparator={','}
                    duration={1}
                  />
                </TYPE.largeHeader>
