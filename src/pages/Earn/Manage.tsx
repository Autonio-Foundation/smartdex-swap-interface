        ...
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              ...
              <a href="https://app.uniswap.org/#/add/ETH/0xc813EA5e3b48BEbeedb796ab42A30C5599b01740" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                <ButtonPrimary
                  padding="8px"
                  borderRadius="8px"
                  width={'fit-content'}
        ...
        <BottomSection gap="lg" justify="center">
          ...
          <StyledBottomCard dim={stakingInfo?.stakedAmount?.equalTo(JSBI.BigInt(0))}>
            ...
            <AutoColumn gap="sm">
              <RowBetween>
                <div>
                  <TYPE.black>Your unclaimed NIOX</TYPE.black>
                </div>
          ...
          <DataRow style={{ marginBottom: '1rem' }}>
            { !stakingInfo?.ended &&
              <ButtonPrimary padding="8px" borderRadius="8px" width="160px" onClick={handleDepositClick}>
                {stakingInfo?.stakedAmount?.greaterThan(JSBI.BigInt(0)) ? 'Deposit' : stakingInfo && stakingInfo?.name !== '' ? 'Deposit ' + stakingInfo?.name + " Tokens" : 'Deposit Uniswap V2 LP Tokens'}
              </ButtonPrimary>
            }
